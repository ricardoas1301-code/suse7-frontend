-- ======================================================================
-- Migration: Tabela product_ad_titles — títulos alternativos para anúncios
-- Cada produto pode ter até 10 títulos. Unicidade case-insensitive por produto.
-- ======================================================================
...
-- Trigger: manter title_normalized (trim + lower + colapsar espaços)
...
-- RLS (idempotente: DROP IF EXISTS antes de CREATE)
