-- ======================================================================
-- FASE 2 — Enriquecimento marketplace_listings (ML / multi-marketplace)
-- Colunas adicionais: loja oficial, inventário, garantia, tags, contagens,
-- espelho de frete na principal, Mercado Pago. Idempotente (IF NOT EXISTS).
-- ======================================================================
