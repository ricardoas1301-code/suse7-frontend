...
export function extrairContextoSelecaoPromocao(promocaoFonte) {
  ...
  return {
    ...
    selected_final_price:
      cardRec?.real_promotion_final_price_brl != null
        ? String(cardRec.real_promotion_final_price_brl)
        : cardRec?.selected_final_price != null
          ? String(cardRec.selected_final_price)
          : null,
    selected_discount_amount:
      cardRec?.discount_amount_brl != null
        ? String(cardRec.discount_amount_brl)
        : cardRec?.selected_discount_amount != null
 ...
 */
export function mesclarMetadadosPromocaoNoCenario(cenarioSimulado, promocaoFonte) {
  ...
  if (cardContract != null) {
    if (cardContract.real_promotion_final_price_brl != null) {
      const finalStr = String(cardContract.real_promotion_final_price_brl);
