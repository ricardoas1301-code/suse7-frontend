...
assert(
  "visual label Nome fantasia",
  /Nome fantasia/.test(signupSource) && !/Nome da loja/.test(signupSource),
);
...
assert(
  "visual order line 1 razao + nome fantasia",
  /Linha 1: Razão social \| Nome fantasia/.test(signupSource),
);
