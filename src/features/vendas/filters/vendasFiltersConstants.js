...
/** @type {readonly { id: import("./vendasFiltersPeriod.js").VendasPeriodPresetUi | "operational_cycle"; label: string }[]} */
export const DASHBOARD_DAILY_SUMMARY_PERIOD_PRESETS = [
  { id: "operational_cycle", label: "Ciclo operacional" },
  ...VENDAS_PERIOD_PRESETS,
];
