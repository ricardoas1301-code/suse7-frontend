...
import { PRICING_HEALTH_SUMMARY_REFRESH_EVENT } from "../api/pricingHealthSummaryRefreshEvents.js";
...
export default function PricingHealthCenter({
  ...
  useEffect(() => {
    ...
    window.addEventListener(PRICING_HEALTH_SUMMARY_REFRESH_EVENT, onRefresh);
    return () => window.removeEventListener(PRICING_HEALTH_SUMMARY_REFRESH_EVENT, onRefresh);
  }, []);
