    ...
    >
      ...
      <div className="configuration-onboarding-preconfirm">
        ...
        <div
          ...
          className="configuration-onboarding-preconfirm__notice configuration-onboarding-preconfirm__notice--important"
        ...
        >
          ...
          <S7Icon
            ...
            className="configuration-onboarding-preconfirm__notice-icon"

            aria-hidden

          />

          <div className="configuration-onboarding-preconfirm__notice-body">

            <p className="configuration-onboarding-preconfirm__notice-title">IMPORTANTE</p>

            <p className="configuration-onboarding-preconfirm__copy">{ML_INTEGRATION_PRE_AUTH_ACCOUNT_CONFIRM}</p>
