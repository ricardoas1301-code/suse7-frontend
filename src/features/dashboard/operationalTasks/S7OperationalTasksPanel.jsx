      ...
      {isCollapsed ? (
        ...
        >
          ...
          <img
            ...
            alt=""
            className="s7-operational-tasks-panel__collapsed-illustration"
            aria-hidden
            decoding="async"
          />
        ...
        <>
          ...
          <header className="s7-operational-tasks-panel__header">
            ...
            <h2 className="s7-operational-tasks-panel__title">
              ...
              {showOnboardingExpandedHeader ? (
              <img
                src={onboardingOperacaoIllustration}
                alt=""
                className="s7-operational-tasks-panel__title-illustration"
                aria-hidden
                decoding="async"
              />
              ) : null}
