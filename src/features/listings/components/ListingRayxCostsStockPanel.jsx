...
/**
 * @param {{
 *   costsFields: Array<{ id: string; label: string; value: string; tooltip?: string }>;
            ...
            <dl className="listing-rayx-readonly-fields">
              {costsFields.map((campo) => (
                <div key={campo.id} className="listing-rayx-readonly-fields__row">
                  <dt className="listing-rayx-readonly-fields__label">
                    <span className="listing-rayx-readonly-fields__label-text">{campo.label}</span>
                    {campo.tooltip ? (
                      <S7Tooltip content={campo.tooltip} placement="top-start" offset={6} wrap>
                        <button
                          type="button"
                          className="listing-rayx-readonly-fields__info-btn"
                          aria-label={`Informações sobre ${campo.label}`}
                        >
