...
function ProductCatalogRow({
  ...
  return (
    <div
      className={`products-catalog__row${showMarketplacesColumn ? " products-catalog__row--with-marketplaces" : ""}${catalogIncomplete ? " products-catalog__row--incomplete-catalog" : ""}${selected ? " products-catalog__row--selected" : ""}`}
      role="button"
      tabIndex={0}
...
export default function Products() {
  ...
  const [catalogFilterId, setCatalogFilterId] = useState("top_sales");
      ...
      <div ref={catalogTableBlockRef} className="products-catalog__table-block">
        <div className="products-catalog__list-sticky-chrome" aria-label="Busca, filtros e cabeçalho da lista">
          ...
          <ProductsFiltersCard
            ...
            hasActiveFilters={catalogFilterId !== "top_sales" || catalogSearchQuery.trim().length > 0}
            onClearAll={() => {
              setCatalogFilterId("top_sales");
