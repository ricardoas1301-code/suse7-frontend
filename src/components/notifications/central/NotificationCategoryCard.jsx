import { formatNotificationTypeCount } from "../../../constants/notificationCenterSections";
...
export default function NotificationCategoryCard({
  ...
  if (!category || !(category.types?.length ?? 0)) return null;
  ...
  return (
    ...
    >
      ...
      <header className="s7-ncat-card__head">
        ...
        <span className="s7-ncat-card__count">{formatNotificationTypeCount(category.types?.length ?? 0)}</span>
