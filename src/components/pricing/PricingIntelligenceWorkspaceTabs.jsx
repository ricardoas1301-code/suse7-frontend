...
import { PricingIntelligencePromotionsBetaNotice } from "./PricingIntelligencePromotionsBetaNotice.jsx";
...
export function PricingIntelligenceWorkspaceTabs({
  ...
  return (
    <>
      <div
        className={`${shellBaseClass} pricing-intelligence-page__workspace-shell--simulator-tab`}
        hidden={!simActive}
      ...
      {mountPromotionsLayout ? (
          ...
          >
            ...
            <div className="pricing-intelligence-page__workspace-dual-scenario-right-col">
              ...
              >
                <PricingIntelligencePromotionsBetaNotice />
                <PricingIntelligencePromotionsCompactPicker activeWorkspaceTab={activeTab} />
              </div>
            </div>
          </div>
      ) : null}
